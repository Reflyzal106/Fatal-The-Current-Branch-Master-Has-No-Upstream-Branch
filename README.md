# [SOLVED] Fatal-The-Current-Branch-Master-Has-No-Upstream-Branch
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/fatal-the-current-branch-master-has-no-upstream-branch)
>
...
The issue is that you haven't linked your local branch to a remote branch. To fix this, use the following command: git push -u origin master
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/fatal-the-current-branch-master-has-no-upstream-branch)**
